...
|--------------|-----------|----------------|--------|
| TC_LOGIN_001 | Login dengan email & password valid | Berhasil masuk ke dashboard | Passed |

# Employee Management Test

| Test Case ID | Scenario | Expected Result | Status |
|--------------|-----------|----------------|--------|
| TC_EMP_001 | Add Employee dengan data valid | Employee berhasil ditambahkan | Passed |
| TC_EDIT_EMP_001 | Edit Employee | Employee berhasil diupdate | Passed |
| TC_DEL_EMP_001 | Delete Employee | Employee berhasil dihapus | Passed |

# Employee API Test

| Test Case ID | Scenario | Expected Result | Status |
|--------------|-----------|----------------|--------|
| API_LOGIN_001 | Login API | Berhasil login dengan status code 200 | Passed |
| API_EMP_001 | Add Employee API | Employee berhasil dibuat dengan ID unik | Passed |
| API_EMP_002 | Edit Employee API | Employee berhasil diupdate | Passed |
| API_EMP_003 | Delete Employee API | Employee berhasil dihapus | Passed |
